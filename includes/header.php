    ...
    <header class="header-mode-<?php echo $setting['headerMode']; ?> <?php if (empty($banner)) echo 'force-dark no-banner'; ?>">
        <div class="container wider">
            <nav>
                ...
                <a class="brand" href="<?php Utils::index(''); ?>"><?php if ($setting['name']) echo $setting['name'];
                                                                    else echo $this->options->title; ?></a>
                ...
                <?php if ($setting['nav']) {
                    foreach ($setting['nav'] as $listItem): ?>
                        ...
                        <?php else: ?>
                            <a href="<?php echo $listItem['link']; ?>" target="_blank"><?php echo $listItem['name']; ?></a>
                        <?php endif; ?>
                <?php endforeach;
                } ?>
    ...
    <div id="nav-mobile">
        <section id="pages" data-title="PAGES">
            <nav>
                ...
                <?php if ($setting['nav']) {
                    foreach ($setting['nav'] as $listItem): ?>
                        <?php if (isset($listItem['items']) == false) : ?>
                            <a href="<?php echo $listItem['link']; ?>" target="_blank"><?php echo $listItem['name']; ?></a>
                        <?php endif; ?>
                <?php endforeach;
                } ?>
